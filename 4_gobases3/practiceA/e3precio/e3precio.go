...
func main() {
	...
	// fmt.Println("Total Products: ", <-cp)
	// fmt.Println("Total Services: ", <-cs)
	// fmt.Println("Total Maintenance: ", <-cm)

	// Los punteros ahorran memoria, pasando datos por referencia.
	// Cuando paso el valor por valor, estoy copiando el valor original.
	// Ojo al trabajar con punteros y go rutines.
	// Los chanels son como una pila.
