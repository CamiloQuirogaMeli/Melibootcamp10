...
func main() {
	//a
	var alumnos = []string{"Benjamin", "Nahuel", "Brenda", "Marcos", "Pedro", "Axel", "Alez", "Dolores", "Federico", "Hernan", "Leandro", "Eduardo", "Duvraschka"}

	fmt.Println("Listado de alumnos inicial: ", alumnos)

	//b
	alumnos = append(alumnos, "Gabriela")

	fmt.Println("\n\nListado de alumnos final: ", alumnos)
